          ...
          >
            ...
            {plan.next_appointment && (
              <div style={{
                ...
                <p style={{ fontSize: '12px', fontWeight: '600', color: '#135450', margin: '0 0 2px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  Next appointment
                </p>
                <p style={{ fontSize: '14px', color: '#0d3d3a', fontWeight: '500', margin: 0 }}>
                  {plan.next_appointment}
                </p>
              </div>
            )}
